...
<h1><?php echo lang('calendar_collaborators_title');
?> &nbsp;
<?php echo $help;
?></h1>

<p><?php echo lang('calendar_collaborators_description');
?></p>
...
?></span></div>
<div class="span3"><span class="label label-important" style="background-color: #ff0000;"><?php echo lang('Rejected');
?></span></div>
</div>

...
<link href="<?php echo base_url();?>assets/css/tabular.css" rel="stylesheet">
           <h1><?php echo lang('calendar_year_title');
?>&nbsp;
...
<div class="row-fluid">
               <div class="span4">
                              <span class="label"><?php echo lang('Planned');
?></span>&nbsp;
<span class="label label-success"><?php echo lang('Accepted');
?></span>&nbsp;
<span class="label label-warning"><?php echo lang('Requested');
?></span>&nbsp;
<span class="label label-important" style="background-color: #ff0000;"><?php echo lang('Rejected');
?></span>
</div>
<div class="span4">
               <a href="<?php echo base_url();?>calendar/year/export/<?php echo $user_id;?>/<?php echo ($year);?>" class="btn btn-primary"><i class="fa fa-file-excel-o"></i>&nbsp;
<?php echo lang('calendar_year_button_export');
?></a>
</div>
<div class="span4">
...
<?php foreach ($months as $month_name => $month) {
    ?>
    <tr>
    <td rowspan="2"><?php echo $month_name;
    ?></td>
    ...
    foreach ($month->days as $day) {
        ...
        if ($display == 1 || $display == 2) {
            ...
            {
            case 1:
                echo '<td title="' . $type .'" class="allplanned">&nbsp;</td>';
                break;  // Planned
            case 2:
                echo '<td title="' . $type .'" class="allrequested">&nbsp;</td>';
                break;  // Requested
            case 3:
                echo '<td title="' . $type .'" class="allaccepted">&nbsp;</td>';
                break;  // Accepted
            case 4:
                echo '<td title="' . $type .'" class="allrejected">&nbsp;</td>';
                break;  // Rejected
            }
        }
        $pad_day++;

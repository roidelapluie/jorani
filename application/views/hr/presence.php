...
<link href="<?php echo base_url();?>assets/css/tabular.css" rel="stylesheet">
           <div class="row-fluid">
                          <div class="span12">
                                         ...
                                         <h2><?php echo lang('hr_presence_title');
?><span class="muted">&nbsp;
(<?php echo $employee_name; ?>&nbsp; |&nbsp; <?php echo lang($month_name); ?>&nbsp; <?php echo $year; ?>)</span> &nbsp;
<?php echo $help;
?></h2>

<p><?php echo lang('hr_presence_description');
?></p>
...
<div class="row-fluid">
               <div class="span6">
                              <div id='calendar'></div>
                                      ...
                                      <div class="span3">
                                                  <br /><br />
                                                  <p><?php echo lang('hr_presence_employee');
?> : <b><?php echo $employee_name;
?></b></p>
<p><?php echo lang('hr_presence_month');
?> : <b><?php echo lang($month_name);
?>&nbsp;
<?php echo $year;
?></b></p>
<p><?php echo lang('hr_presence_days');
?> : <b><?php echo $total_days;
?></b></p>
<?php if ($contract_id != '') {
    ?>
    <p><?php echo lang('hr_presence_contract');
    ?> : <b><?php echo $contract_name;
    ?></b></p>
    <p><?php echo lang('hr_presence_working_days');
    ?> : <b><?php echo $opened_days;
    ?></b></p>
    <?php if ($source == 'collaborators') {
        ?>
        <p><?php echo lang('hr_presence_non_working_days');
        ?> : <b><?php echo $non_working_days;
        ?></b></p>
        <?php
    }
    else {
        ?>
        <p><?php echo lang('hr_presence_non_working_days');
        ?> : <b><a href="<?php echo base_url();?>contracts/<?php echo $contract_id; ?>/calendar"><?php echo $non_working_days;
        ?></a></b></p>
        <?php
    } ?>
    <?php
    ...
    ?>
    <p><?php echo lang('hr_presence_contract');
    ?> : <i class="icon-warning-sign"></i><?php echo lang('hr_presence_no_contract');
    ?></p>
    <p><?php echo lang('hr_presence_working_days');
    ?> : <i class="icon-warning-sign"></i><?php echo lang('hr_presence_no_contract');
    ?></p>
...
<p><?php echo lang('hr_presence_work_duration');
?> : <b><?php echo $work_duration;
?></b>&nbsp;
<i class="icon-hand-left"></i><?php echo lang('hr_presence_please_check');
?></p>
<p><?php echo lang('hr_presence_leave_duration');
?> : <b><?php echo $leave_duration;
?></b>&nbsp;
<i class="icon-hand-left"></i><?php echo lang('hr_presence_please_check');
?></p>
<?php if (count($leaves_detail) > 0) {
    ...
    <?php foreach ($leaves_detail as $leaves_type_name => $leaves_type_sum) {
        ?>
        <li><?php echo $leaves_type_name;
        ?> : <?php echo $leaves_type_sum;
        ?></li>
        <?php
    } ?>
    </ul>
...
<div class="span3">
               <br /><br />
               <label for="cboMonth"><?php echo lang('calendar_tabular_field_month');
?></label>
...
<label for="cboYear"><?php echo lang('calendar_tabular_field_year');
?></label>
...
<button id="cmdPrevious" class="btn btn-primary"><i class="icon-chevron-left icon-white"></i></button>
                                       <button id="cmdExecute" class="btn btn-primary"><?php echo lang('hr_presence_button_execute');
?></button>
<button id="cmdNext" class="btn btn-primary"><i class="icon-chevron-right icon-white"></i></button>
                                   <br /><br />
                                   <a href="<?php echo base_url() . 'hr/presence/export/' . $source . '/' . $user_id . '/' . $month . '/' . $year;?>" class="btn btn-primary"><i class="fa fa-file-excel-o"></i>&nbsp;
<?php echo lang('hr_presence_button_export');
?></a>
</div>
</div>
...
<h3><?php echo lang('hr_presence_leaves_list_title');
?></h3>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="leaves" width="100%">
                                       <thead>
                                       <tr>
                                       <th><?php echo lang('hr_presence_thead_id');
?></th>
<th><?php echo lang('hr_presence_thead_start');
?></th>
<th><?php echo lang('hr_presence_thead_end');
?></th>
<th><?php echo lang('hr_presence_thead_duration');
?></th>
<th><?php echo lang('hr_presence_thead_type');
?></th>
</tr>
</thead>
<tbody>
...
<td data-order="<?php echo $leave['id']; ?>">
               <a href="<?php echo base_url();?>leaves/edit/<?php echo $leave['id']; ?>?source=hr%2Fpresence%2F<?php echo $user_id; ?>" title="<?php echo lang('hr_presence_thead_tip_edit');?>"><?php echo $leave['id'] ?></a>
                       ...
                       <td data-order="<?php echo $tmpStartDate; ?>"><?php echo $startdate . ' (' . lang($leave['startdatetype']). ')';
?></td>
<td data-order="<?php echo $tmpEndDate; ?>"><?php echo $enddate . ' (' . lang($leave['enddatetype']) . ')';
?></td>
<td><?php echo $leave['duration'];
?></td>
<td><?php echo $leave['type'];
?></td>
</tr>
<?php endforeach ?>
</tbody>
...
<div class="row-fluid">
               <div class="span12">
                              <h3><?php echo lang('hr_summary_title');
?>&nbsp;
<?php echo $employee_id;
?>&nbsp;
<span class="muted"> (<?php echo $employee_name; ?>)</span>&nbsp;
<?php echo $help;
?></h3>
...
<input type="text" value="<?php echo $refDate; ?>" readonly />
                         ...
                         <table class="table table-bordered table-hover">
                                          <thead>
                                          <tr>
                                          <th><?php echo lang('hr_summary_thead_type');
?></th>
<th><?php echo lang('hr_summary_thead_available');
?></th>
<th><?php echo lang('hr_summary_thead_taken');
?></th>
<th><?php echo lang('hr_summary_thead_entitled');
?></th>
<th><?php echo lang('hr_summary_thead_description');
?></th>
</tr>
</thead>
<tbody>
...
<?php if ($source == 'employees') {
    ...
    <div class="row-fluid">
                   <div class="span12">
                                  <a href="<?php echo base_url();?>hr/employees" class="btn btn-primary"><i class="icon-arrow-left icon-white"></i>&nbsp;
    <?php echo lang('hr_presence_button_list');
    ?></a>
    </div>
    </div>
    <?php

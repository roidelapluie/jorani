...
<div class="row-fluid">
               <div class="span12">
                              ...
                              <h2><?php echo lang('requests_delegations_title');
?> <span class="muted">(<?php echo $name; ?>)</span>  &nbsp;
<?php echo $help;
?></h2>

<div class="row-fluid"><div class="span12"><?php echo lang('requests_delegations_description');
?></div></div>
...
<th><?php echo lang('requests_delegations_thead_employee');
?></th>
</tr>
</thead>
<tbody>
<?php foreach ($delegations as $delegation) {
    ...
    <tr data-id="<?php echo $delegation['id']; ?>">
                <td><a href="#" onclick="delete_delegation(<?php echo $delegation['id'] ?>);" title="<?php echo lang('requests_delegations_thead_tip_delete');?>"><i class="icon-remove"></i></a></td>
                                            <td><?php echo $delegation['delegate_name'];
    ?></td>
    </tr>
    <?php
} ?>
...
<button id="cmdAddDelegate" class="btn btn-primary" onclick="$('#frmSelectDelegate').modal('show');"><i class="icon-plus-sign icon-white"></i>&nbsp;
<?php echo lang('requests_delegations_button_add');
?></button>
<div class="row-fluid"><div class="span12">&nbsp;
</div></div>
...
<div id="frmSelectDelegate" class="modal hide fade">
                                      <div class="modal-header">
                                                  <a href="#" onclick="$('#frmSelectDelegate').modal('hide');" class="close">&times;
</a>
<h3><?php echo lang('requests_delegations_popup_delegate_title');
?></h3>
</div>
<div class="modal-body" id="frmSelectDelegateBody">
                               <img src="<?php echo base_url();?>assets/images/loading.gif">
                                        ...
                                        <div class="modal-footer">
                                                    <a href="#" onclick="select_delegate();" class="btn secondary"><?php echo lang('requests_delegations_popup_delegate_button_ok');
?></a>
<a href="#" onclick="$('#frmSelectDelegate').modal('hide');" class="btn secondary"><?php echo lang('requests_delegations_popup_delegate_button_cancel');
?></a>
</div>
</div>

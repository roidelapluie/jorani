...
<input type="hidden" name="CipheredValue" id="CipheredValue" />
                          ...
                          <label for="firstname"><?php echo lang('users_create_field_firstname');
?></label>
<input type="text" name="firstname" id="firstname" required /><br />

                                       <label for="lastname"><?php echo lang('users_create_field_lastname');
?></label>
<input type="text" name="lastname" id="lastname" required /><br />

                                      <label for="role[]"><?php echo lang('users_create_field_role');
?></label>
<select name="role[]" multiple="multiple" size="2" required>
                               <?php foreach ($roles as $roles_item): ?>
                                   <option value="<?php echo $roles_item['id'] ?>" <?php if ($roles_item['id'] == 2) echo "selected";
?>><?php echo $roles_item['name'] ?></option>
 <?php endforeach ?>
 </select>

 <label for="login"><?php echo lang('users_create_field_login');
?></label>
<input type="text" name="login" id="login" required /><br />
                                   <div class="alert hide alert-error" id="lblLoginAlert">
                                               <button type="button" class="close" onclick="$('#lblLoginAlert').hide();">&times;
</button>
<?php echo lang('users_create_flash_msg_error');
?>
</div>

<label for="email"><?php echo lang('users_create_field_email');
?></label>
<input type="email" id="email" name="email" required /><br />

                                    <input type="hidden" name="manager" id="manager" /><br />
                                            <label for="txtManager"><?php echo lang('users_create_field_manager');
?></label>
<div class="input-append">
               <input type="text" id="txtManager" name="txtManager" required readonly />
                                     <a id="cmdSelfManager" class="btn btn-primary"><?php echo lang('users_create_button_self');
?></a>
<a id="cmdSelectManager" class="btn btn-primary"><?php echo lang('users_create_button_select');
?></a>
</div><br />
<i><?php echo lang('users_create_field_manager_description');
?></i>
<br /><br />

<label for="contract"><?php echo lang('users_create_field_contract');
?></label>
...
<input type="hidden" name="entity" id="entity" /><br />
                                      <label for="txtEntity"><?php echo lang('users_create_field_entity');
?></label>
<div class="input-append">
               <input type="text" id="txtEntity" name="txtEntity" readonly />
                                     <a id="cmdSelectEntity" class="btn btn-primary"><?php echo lang('users_create_button_select');
?></a>
</div>
<br />

<input type="hidden" name="position" id="position" /><br />
                                        <label for="txtPosition"><?php echo lang('users_create_field_position');
?></label>
<div class="input-append">
               <input type="text" id="txtPosition" name="txtPosition" readonly />
                                     <a id="cmdSelectPosition" class="btn btn-primary"><?php echo lang('users_create_button_select');
?></a>
</div>
<br />

<label for="viz_datehired"><?php echo lang('users_create_field_hired');
?></label>
<input type="text" id="viz_datehired" name="viz_datehired" /><br />
                      <input type="hidden" name="datehired" id="datehired" />

                                  <label for="identifier"><?php echo lang('users_create_field_identifier');
?></label>
<input type="text" name="identifier" /><br />

                        <label for="language"><?php echo lang('users_create_field_language');
?></label>
...
foreach ($languages as $code => $language): ?>
    ...
    ?>
    <label for="timezone"><?php echo lang('users_create_field_timezone');
    ?></label>
    <select id="timezone" name="timezone" class="selectized input-xlarge">
                                   <?php foreach ($tzlist as $tz) {
        ?>
        <option value="<?php echo $tz ?>" <?php if ($tz == $tzdef) echo "selected";
        ?>><?php echo $tz;
        ?></option>
        <?php
        $index++;
...
<?php if ($this->config->item('ldap_basedn_db')) {
    ?>
    <label for="ldap_path"><?php echo lang('users_create_field_ldap_path');
    ?></label>
...
<?php if (!$this->config->item('ldap_enabled')) {
    ?>
    <label for="password"><?php echo lang('users_create_field_password');
    ?></label>
    <div class="input-append">
                   <input type="password" name="password" id="password" required />
                                               <a class="btn" id="cmdGeneratePassword"><i class="icon-refresh"></i>&nbsp;
    <?php echo lang('users_create_button_generate_password');
    ?></a>
    </div>
    <?php
}?>
...
<button id="send" class="btn btn-primary"><i class="icon-ok icon-white"></i>&nbsp;
<?php echo lang('users_create_button_create');
?></button>
&nbsp;
<a href="<?php echo base_url(); ?>users" class="btn btn-danger"><i class="icon-remove icon-white"></i>&nbsp;
<?php echo lang('users_create_button_cancel');
?></a>

<div id="frmSelectManager" class="modal hide fade">
                                     <div class="modal-header">
                                                 <a href="#" onclick="$('#frmSelectManager').modal('hide');" class="close">&times;
</a>
<h3><?php echo lang('users_create_popup_manager_title');
?></h3>
</div>
<div class="modal-body" id="frmSelectManagerBody">
                               <img src="<?php echo base_url();?>assets/images/loading.gif">
                                        ...
                                        <div class="modal-footer">
                                                    <a href="#" onclick="select_manager();" class="btn secondary"><?php echo lang('users_create_popup_manager_button_ok');
?></a>
<a href="#" onclick="$('#frmSelectManager').modal('hide');" class="btn secondary"><?php echo lang('users_create_popup_manager_button_cancel');
?></a>
</div>
</div>
...
<h3><?php echo lang('users_create_popup_entity_title');
?></h3>
</div>
<div class="modal-body" id="frmSelectEntityBody">
                               <img src="<?php echo base_url();?>assets/images/loading.gif">
                                        ...
                                        <div class="modal-footer">
                                                    <a href="#" onclick="select_entity();" class="btn secondary"><?php echo lang('users_create_popup_entity_button_ok');
?></a>
<a href="#" onclick="$('#frmSelectEntity').modal('hide');" class="btn secondary"><?php echo lang('users_create_popup_entity_button_cancel');
?></a>
</div>
</div>
...
<div id="frmSelectPosition" class="modal hide fade">
                                      <div class="modal-header">
                                                  <a href="#" onclick="$('#frmSelectPosition').modal('hide');" class="close">&times;
</a>
<h3><?php echo lang('users_create_popup_position_title');
?></h3>
</div>
<div class="modal-body" id="frmSelectPositionBody">
                               <img src="<?php echo base_url();?>assets/images/loading.gif">
                                        ...
                                        <div class="modal-footer">
                                                    <a href="#" onclick="select_position();" class="btn secondary"><?php echo lang('users_create_popup_position_button_ok');
?></a>
<a href="#" onclick="$('#frmSelectPosition').modal('hide');" class="btn secondary"><?php echo lang('users_create_popup_position_button_cancel');
?></a>
</div>
</div>
...
<textarea id="pubkey" style="visibility:hidden;"><?php echo $public_key;
?></textarea>

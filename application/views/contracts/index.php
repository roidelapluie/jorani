...
<h1><?php echo lang('contract_index_title');
?> &nbsp;
<?php echo $help;
?></h1>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="contracts" width="100%">
                                       <thead>
                                       <tr>
                                       <th><?php echo lang('contract_index_thead_id');
?></th>
<th><?php echo lang('contract_index_thead_name');
?></th>
<th><?php echo lang('contract_index_thead_start');
?></th>
<th><?php echo lang('contract_index_thead_end');
?></th>
</tr>
</thead>
<tbody>
...
<div class="row-fluid">
               <div class="span12">
                              <a href="<?php echo base_url();?>contracts/export" class="btn btn-primary"><i class="fa fa-file-excel-o"></i>&nbsp;
<?php echo lang('contract_index_button_export');
?></a>
&nbsp;
<a href="<?php echo base_url();?>contracts/create" class="btn btn-primary"><i class="icon-plus-sign icon-white"></i>&nbsp;
<?php echo lang('contract_index_button_create');
?></a>
</div>
</div>
...
<div id="frmDeleteContract" class="modal hide fade">
                                      <div class="modal-header">
                                                  <a href="#" onclick="$('#frmDeleteContract').modal('hide');" class="close">&times;
</a>
<h3><?php echo lang('contract_index_popup_delete_title');
?></h3>
</div>
<div class="modal-body">
               <p><?php echo lang('contract_index_popup_delete_description');
?></p>
<p><?php echo lang('contract_index_popup_delete_confirm');
?></p>
</div>
<div class="modal-footer">
               <a href="#" id="lnkDeleteContract" class="btn danger"><?php echo lang('contract_index_popup_delete_button_yes');
?></a>
<a href="#" onclick="$('#frmDeleteContract').modal('hide');" class="btn secondary"><?php echo lang('contract_index_popup_delete_button_no');
?></a>
</div>
</div>
...
<div id="frmEntitledDays" class="modal hide fade">
                                    <div class="modal-header">
                                                <a href="#" onclick="$('#frmEntitledDays').modal('hide');" class="close">&times;
</a>
<h3><?php echo lang('contract_index_popup_entitled_title');
?></h3>
</div>
<div class="modal-body">
               <img src="<?php echo base_url();?>assets/images/loading.gif">
                        ...
                        <div class="modal-footer">
                                       <a href="#" onclick="$('#frmEntitledDays').modal('hide');" class="btn secondary"><?php echo lang('contract_index_popup_entitled_button_close');
?></a>
</div>
</div>

...
<div class="row-fluid">
               <div class="span12">
                              ...
                              <h2><?php echo lang('entitleddays_user_index_title');
?> <span class="muted"><?php echo $employee_name;
?></span>&nbsp;
<?php echo $help;
?></h2>
...
<th><?php echo lang('entitleddays_user_index_thead_start');
?></th>
<th><?php echo lang('entitleddays_user_index_thead_end');
?></th>
<th><?php echo lang('entitleddays_user_index_thead_days');
?></th>
<th><?php echo lang('entitleddays_user_index_thead_type');
?></th>
<th><?php echo lang('entitleddays_user_index_thead_description');
?></th>
</tr>
</thead>
<tbody>
...
<div class="row-fluid">
               <div class="span6">
                              <a href="<?php echo base_url();?>hr/employees" class="btn btn-danger"><i class="icon-arrow-left icon-white"></i>&nbsp;
<?php echo lang('entitleddays_user_index_button_back');
?></a>
<button id="cmdAddEntitledDays" class="btn btn-primary" onclick="show_add_entitleddays();"><i class="icon-plus-sign icon-white"></i>&nbsp;
<?php echo lang('entitleddays_user_index_button_add');
?></button>
</div>
<div class="span6">
               <div class="pull-right">
                              <label for="txtStep"><?php echo lang('entitleddays_user_index_field_step');
?></label>
...
<div class="modal-body">
               <label for="viz_startdate"><?php echo lang('entitleddays_user_index_field_start');
?></label>
<div class="input-append">
               <input type="text" id="viz_startdate" name="viz_startdate" required />
                                     <button class="btn" id="cmdCurrent" onclick="set_current_period();"><?php echo lang('entitleddays_contract_index_button_current');
?></button>
</div>
<br />
<input type="hidden" name="startdate" id="startdate" />
                          <label for="viz_enddate"><?php echo lang('entitleddays_user_index_field_end');
?></label>
<input type="text" id="viz_enddate" name="viz_enddate" required /><br />
                      <input type="hidden" name="enddate" id="enddate" />
                                  <label for="type"><?php echo lang('entitleddays_user_index_field_type');
?></label>
<select name="type" id="type" required>
                       <?php foreach ($types as $types_item): ?>
                           <option value="<?php echo $types_item['id'] ?>" <?php if ($types_item['id'] == 1) echo "selected" ?>><?php echo $types_item['name'] ?></option>
                                             ...
                                             <label for="days" required><?php echo lang('entitleddays_user_index_field_days');
?></label>
<input type="text" class="input-mini" name="days" id="days" />
                             <label for="description"><?php echo lang('entitleddays_user_index_field_description');
?></label>
...
?></button>
<button id="cmdFrmAddEntitledDays" class="btn btn-primary" onclick="add_entitleddays();"><?php echo lang('entitleddays_user_index_button_add');
?></button>
<button class="btn btn-danger" onclick="$('#frmAddEntitledDays').modal('hide');"><?php echo lang('entitleddays_user_index_button_cancel');
?></button>
</div>
</div>
